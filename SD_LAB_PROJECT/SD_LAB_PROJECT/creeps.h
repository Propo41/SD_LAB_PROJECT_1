...
int creepsLimit = 1; // the more the value, the greater number of creeps will be spawned

bool creepsSegment = false;
//int creepsCount; declared inside declarations.h. if not declared there, then it causes problems
...
void loadImagesCreep2() // level 2
{
	...
	creeps[0].attackID[0] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_01.png"); //CREEPS LOOKING LEFT
	creeps[0].attackID[1] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_02.png");
	creeps[0].attackID[2] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_03.png");
	creeps[0].attackID[3] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_04.png");
	creeps[0].attackID[4] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_05.png");
	creeps[0].attackID[5] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_06.png");
	creeps[0].attackID[6] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_07.png");
	creeps[0].attackID[7] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_08.png");
	creeps[0].attackID[8] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_09.png");
	creeps[0].attackID[9] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_10.png");
	creeps[0].attackID[10] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_11.png");
	creeps[0].attackID[11] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_12.png");
	creeps[0].attackID[12] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack_13.png"); // number 14 sprite left


	creeps[0].attackID[13] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_01.png"); //CREEPS LOOKING RIGHT
	creeps[0].attackID[14] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_02.png");
	creeps[0].attackID[15] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_03.png");
	creeps[0].attackID[16] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_04.png");
	creeps[0].attackID[17] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_05.png");
	creeps[0].attackID[18] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_06.png");
	creeps[0].attackID[19] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_07.png");
	creeps[0].attackID[20] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_08.png");
	creeps[0].attackID[21] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_09.png");
	creeps[0].attackID[22] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_10.png");
	creeps[0].attackID[23] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_11.png");
	creeps[0].attackID[24] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_12.png");
	creeps[0].attackID[25] = iLoadImage("images\\character\\enemy\\creeps2\\attack\\level-2-enemy-attack-L_13.png"); // number 14 sprite left 
...
/*
 ...
 to change their mechanism, edit the parameters passed in functions.
...
void creepDamage(int mode, int attackType)
{
	...
	//	rangeRight = 55;
		...
		//cout << "a = " << (hero.x + rangeRight) << " ";
	//	cout << "b = " << (hero.x + rangeLeft) << "  ";
		//cout << "creeps x : " << creeps[i].x << endl;


		if ((creeps[i].x <= (hero.x + rangeRight)) && (creeps[i].x >= (hero.x + rangeLeft))) //IF CREEP COMES NEAR HERO THEN DAMAGE
		{
				//cout << "HP : " << creeps[i].HP << endl;

			//	cout << "creeps should get hurt by power" << endl;
			...
			if (creeps[i].HP <= 0 && creeps[i].HP >= -2)
			{
				...
				if (rand() % 2) // if it's 1, then gains hp.
				{
...
if at any time the creep comes near hero, then they will start to attack. 
...
void checkCreepsAlive() 
{
	...
	{
		//cout << "creepsCount in creepsAlive function: " << creepsCount << endl;
...
/*
TIMER FUNCTION: 
DAMAGE animation effect mechanism
