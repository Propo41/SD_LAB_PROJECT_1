...
/*
initializeHero(): during hero selection, this is called to initialize the heroes
...
void heroGain(int mode)
{
	if (mode == HPBAR)
	{
		...
		if (hero_1)
		{
			...
			if (H1_HPbar.variable2 >= 370)
			{
				H1_HPbar.variable1 = 390;
				H1_HPbar.variable2 = 370;
			}
		...
		else
		{
			...
			if (H1_HPbar.variable2 >= 359)
			{
				H1_HPbar.variable1 = 378;
				H1_HPbar.variable2 = 359;
			}
